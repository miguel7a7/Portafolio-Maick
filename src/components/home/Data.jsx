...
export const Data = () => {
  return (
    <div className="data__container">
      ...
      <h3 className="data__subtitle">Diseñador Web</h3>
      <p className="data__description">
        Soy un diseñador creativo, apasionado y dedicado a mi trabajo,
        actualmente me ubico en la ciudad de La Paz - Bolivia
      </p>

      <a href="#contact" className="btn btn-primary data__btn">
        Hablemos <IoIosSend className="data__btn-icon" />
      </a>
    </div>
  )
}
